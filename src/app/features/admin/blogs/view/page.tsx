...
export default function ViewBlogPage() {
  ...
  const handleEditChange = (
    ...
    if (name === "title") {
      setEditBlog({ ...editBlog, title: value, slug: generateSlug(value) });
    } else {
      ...
      <main className="p-6 bg-white rounded-xl shadow-sm">
        ...
        <div className="relative mb-4">
          ...
          <input
            ...
            className="w-full pl-10 pr-4 py-2 border border-slate-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-cyan-500"
          />
        </div>
...
//     {/* 📋 Tabel Data */}
//     <div className="bg-white rounded-md shadow-md overflow-x-auto border border-slate-200 scroll-hidden">
//       <table className="min-w-full text-sm text-left text-gray-700 border-collapse">
//         <thead className="text-xs uppercase bg-cyan-800 text-white">
//           <tr>
//             <th className="px-4 py-3">No</th>
...
//         {/* 🔹 Judul — teks rapi, tidak terlalu tinggi */}
//         <td className="px-4 py-3 max-w-[200px] truncate align-middle">
//           <span title={blog.title}>{blog.title}</span>
//         </td>

//         <td className="px-4 py-3 align-middle">{blog.slug || "-"}</td>
//         <td className="px-4 py-3 align-middle">{blog.category || "-"}</td>
//         <td className="px-4 py-3 align-middle">{blog.author_email || "-"}</td>

//         {/* 🔹 Isi Blog — 2 baris saja */}
//         <td className="px-4 py-3 max-w-[250px] line-clamp-2 align-middle">
//           {blog.content || "-"}
//         </td>
