...
export default function CheckoutPage() {
  ...
  return (
    ...
    <div className="mt-32 max-w-6xl mx-auto py-10 px-4 grid grid-cols-1 lg:grid-cols-2 gap-8 relative">
      ...
      {/* 🧾 Left: Billing */}
      <div className={`bg-white p-6 rounded-lg shadow-md border border-slate-200 ${hkGrotesk.className}`}>
...
<div className="mt-6 p-5 border border-green-300 rounded-md shadow-md bg-green-50">
  <div className="flex items-center gap-2 mb-2">
    ...
    <p className="font-semibold text-green-700">Order berhasil dibuat!</p>
  </div>
...
>
  <div className={`fixed inset-0 flex items-center justify-center bg-slate-500/20 z-50 ${hkGrotesk.className}`}>
